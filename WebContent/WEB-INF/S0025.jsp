	...
	<!-- 売上削除システム表示 -->
		<div class="container">
			...
			<form class="form-horizontal" method="post" action="S0025.html">
				...
				<!-- 商品カテゴリー -->
				<div class="form-group">
					<label for="categoryId" class="col-xs-3 text-right control-label">商品カテゴリー</label>
					<div class="col-xs-5">
				...
				<div class="form-group">
					<div class="col-xs-8 col-xs-offset-4">
						<button type="submit" class="btn btn-danger">
							<span class="glyphicon glyphicon-remove" aria-hidden="true"></span> ＯＫ
						</button>
						<a class="btn btn-default" href="S0022.html?saleId=${form.saleId}" role="button">キャンセル</a><!-- 売上詳細表示画面へ -->
					</div>
				</div>
