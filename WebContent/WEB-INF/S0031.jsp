...
<jsp:include page="_header.jsp">
	...
	<div class="container">
		...
		<form class="form-horizontal" method="post" action="S0031.html">
			...
			<div class="form-group">
				 <label for="password1" class="col-sm-offset-1 col-sm-2  control-label">
			...
			<div class="form-group">
				 <label for="password2" class="col-sm-offset-1 col-sm-2  control-label">
				 	パスワード(確認) <span class="badge">必須</span>
				 </label>
				 <div class="col-sm-4">
					<input type="password" class="form-control" name="password2" id="password2" value="${form.password2}" placeholder="パスワード(確認)" disabled>
				 </div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
						<label class="radio-inline"><input type="radio" name="salesAuthority" value="no" ${HTMLUtils.writeChecked('no',form.salesAuthority)} disabled>権限なし</label>
						<label class="radio-inline"><input type="radio" name="salesAuthority" value="yes" ${HTMLUtils.writeChecked('yes',form.salesAuthority)} disabled>権限あり</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
						<label class="radio-inline"><input type="radio" name="accountAuthority" value="no" ${HTMLUtils.writeChecked('no',form.accountAuthority)} disabled>権限なし</label>
						<label class="radio-inline"><input type="radio" name="accountAuthority" value="yes" ${HTMLUtils.writeChecked('yes',form.accountAuthority)} disabled>権限あり</label>
				</div>
			</div>
